        ...
        <div style={{ width: "100%", maxWidth: 420 }}>
          ...
          {done ? (
            <div style={{ background: "#fff", borderRadius: 20, border: "1px solid #ece7f5", padding: 40, boxShadow: "0 4px 24px rgba(15,11,30,.06)", textAlign: "center" }}>
              ...
              <h1 style={{ fontSize: 22, fontWeight: 700, color: "#0f0b1e", margin: "0 0 10px", letterSpacing: "-0.02em" }}>Verifique seu e-mail</h1>
              <p style={{ fontSize: 14, color: "#6e6880", margin: "0 0 24px", lineHeight: 1.6 }}>
                Enviamos um link de redefinição para <strong style={{ color: "#0f0b1e" }}>{email}</strong>. Clique no link para criar uma nova senha.
              </p>
              <p style={{ fontSize: 12, color: "#9994ac", margin: "0 0 24px" }}>
            ...
            <div style={{ background: "#fff", borderRadius: 20, border: "1px solid #ece7f5", padding: 40, boxShadow: "0 4px 24px rgba(15,11,30,.06)" }}>
              ...
              <h1 style={{ fontSize: 24, fontWeight: 700, color: "#0f0b1e", margin: "0 0 8px", letterSpacing: "-0.025em" }}>Esqueceu a senha?</h1>
              ...
              <form onSubmit={handleSubmit} style={{ display: "flex", flexDirection: "column", gap: 16 }}>
                <div style={{ display: "flex", flexDirection: "column", gap: 6 }}>
                  <label style={{ fontSize: 11, fontWeight: 600, color: "#6e6880", textTransform: "uppercase", letterSpacing: ".04em" }}>E-mail</label>
                  <input
                    type="email"
                    value={email}
                    ...
                    autoComplete="email"
                    autoFocus
                    style={{ height: 44, padding: "0 14px", borderRadius: 10, border: `1.5px solid ${error ? "#e1124e" : "#ece7f5"}`, fontSize: 14, fontFamily: "inherit", outline: "none", color: "#0f0b1e", background: "#fff", transition: "border .15s", boxSizing: "border-box", width: "100%" }}
              ...
              <div style={{ textAlign: "center", marginTop: 20 }}>
                <Link href="/" style={{ fontSize: 13, color: "#6e6880", textDecoration: "none" }}>
